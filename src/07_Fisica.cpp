...
int main()
{
    ...
    cuerpoSueloDef.type = b2_staticBody;
    ...
    float radioBolaFloat = 25.0f;
    b2Circle formaBola = {{0.0f, 0.0f}, radioBolaFloat};
    ...
    while (ventana.isOpen())
    {
        ...
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left))
            b2Body_ApplyLinearImpulse(cuerpoBola, {-fuerza, 0}, b2Body_GetPosition(cuerpoBola), true);
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right))
            b2Body_ApplyLinearImpulse(cuerpoBola, {fuerza, 0}, b2Body_GetPosition(cuerpoBola), true);
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up))
            b2Body_ApplyLinearImpulse(cuerpoBola, {0, -fuerza}, b2Body_GetPosition(cuerpoBola), true);
        ...
        // Dibujar la bola
        sf::CircleShape bola(radioBolaFloat);
        bola.setOrigin(radioBolaFloat, radioBolaFloat);
